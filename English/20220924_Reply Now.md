...
```E-mail
Received: from [156.96.154.81] (n49-193-242-40.sun2.vic.optusnet.com.au [49.193.242.40]) by mail105.syd.optusnet.com.au (Postfix) with ESMTP id 902831100ECB; Sat, 24 Sep 2022 12:16:42 +1000 (AEST)
...
X-Optus-CM-Score: 0
X-Optus-CM-Analysis: v=2.4 cv=OJNEYQWB c=1 sm=1 tr=0 ts=632e6896 a=H6aWw1kkfuLkawk7K1ZdUA==:117 a=H6aWw1kkfuLkawk7K1ZdUA==:17 a=HpEJnUlJZJkA:10 a=8nJEP1OIZ-IA:10 a=gJybXteCMXIA:10 a=WIs_F5swev6D_-ZPtHYA:9 a=wPNLvfGTeEIA:10
```
---
#### Body Text
```
